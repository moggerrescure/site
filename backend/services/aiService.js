...
async function reconstructPage(rawText, currentBlocks, currentHeader = {}) {
  ...
  const system = [
    ...
    '4. SET_HEADER: если в рассказе названы имя покойного, годы жизни, город или просится эпитафия — ОБЯЗАТЕЛЬНО верни эту команду ПЕРВОЙ: { "action": "SET_HEADER", "name": "Имя Отчество Фамилия", "born": "1921", "died": "1986", "city": "Минск", "epitaph": "краткая тёплая эпитафия" }. Поля, которых нет в рассказе, опусти.',
    '',
